...
#segmented plate
    ...
    folder_name = "./English/pred/img"+ str(count)
    ...
    count+=1
  return rect_list,seg_list,bot_left

path = '1.png'
rect_list,seg_list,bot_left = find_license_plate(path)

#con_img = cv2.drawContours(car_img.copy(),rect_list,-1,(255,0,0),6)
#plt.imshow(con_img)
#cv2.putText(con_img,'BTPX943', 
 #   bot_left, 
